...
suite = {
    ...
    "distributions": {
        ...
        "SVM_BUNDLE_AGENT": {
            "subDir": "src",
            "description" : "Native-image bundle agent",
            "dependencies": [
                "com.oracle.svm.bundleagent",
            ],
            "distDependencies": [
            ...
            "moduleInfo" : {
                "name" : "org.graalvm.nativeimage.agent.bundle",
                "exports" : [
                    "com.oracle.svm.bundleagent",
                ],
            },
